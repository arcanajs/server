/**
 * ArcanaJS Cookie Parser & Plugin - Production Implementation
 *
 * Secure cookie parsing with JSON and signed cookie support.
 * Optimized for Bun runtime with proper error handling.
 */
